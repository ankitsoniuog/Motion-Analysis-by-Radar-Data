...
%==========================================================================
%% Data reading part
pathname = '/Users/sahilchhillar/Documents/MATLAB/data';
dir_name = dir(fullfile(pathname, '*.dat'));
file = {dir_name.name};
...
%     drawnow
    ...
    data_display = 20*log10(abs(Data_spec_MTI2));
    
    figure
    imagesc(MD.TimeAxis,MD.DopplerAxis.*3e8/2/5.8e9,data_display); colormap('jet'); axis xy
    set(gca,'XTick',[])
    set(gca,'YTick',[])
